...
model.load_state_dict(torch.load("../save/pretrain.pt"))
...
for epoch in range(1, epochs + 1):
    ...
    scheduler.step()
# 保存模型
torch.save(model.state_dict(), "../save/fine-tune.pt")
...
df_loss.to_excel("../save/fine_turn_loss.xlsx", index = None)

# 预测
pred = predict_future(model, train_data, 45)
...
df_pred.to_excel("../save/fine_turn_pred.xlsx", index = None)
